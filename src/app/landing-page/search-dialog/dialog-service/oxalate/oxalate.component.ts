...
//       console.log('Filter received in OxalateComponent:', filter); // Log the filter received
...
//     console.log('Applying filters to OxalateComponent:', filter); // Log filters before applying

//     // If no oxalates are loaded, skip filtering
...
//     console.log('Filtered results:', this.displayedOxalates); // Log the filtered results
//   }
// }
// ========
// import { Component, OnInit } from '@angular/core';
